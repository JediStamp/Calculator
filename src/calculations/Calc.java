...
public class Calc {
	...
	/**
	 * This is the angle calc.
	 */
	public static void angleCalc () {
		System.out.println("To determine angle theta, we need two sides of a triangle OR 2 angles" + "\n" 
		...
		case 1: 
			...
			String sides = scans.next().toUpperCase();
			twoSides(sides);
			angleCalc();
			break;
	...
	public static void twoSides(String sides) {
		double preCalc;
		double theta;
		switch(sides) {
		...
		"remember the angle calculated (theta) will be the one opposite of the opposite side and adjacent to the adjacent side."+
